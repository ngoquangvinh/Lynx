    ...
    public class ViewModel
    {
        ...
        public List<ChatListItems> ChatListItems {
            ...
            get {
                ...
                {
                new ChatListItems(){ ContactProfilePic="/assets/logowhiteback.png", ContactName="hoang phuc", LastMessageTime="10:30 PM", Availability="Online", IsRead=true, Message="uit", NewMsgCount="1", IsOnline=true},
                new ChatListItems() { ContactName = "nguyen van a ", LastMessageTime = "14:45 pm", Availability = "Offline", Message = "hello", ContactProfilePic="/assets/profile1.jpg" },
                new ChatListItems() {IsChatSelected=true, ContactName = "Group13_NETWORK_CODING", LastMessageTime = "06:18 am", Availability = "Offline", Message = "hình ảnh", IsRead = false, ContactProfilePic="/assets/profile1.jpg"},
                new ChatListItems() { ContactName = "tran van b", LastMessageTime = "15 Sep 2019", Availability = "Online", Message = "tạm biệt", IsRead = false , ContactProfilePic="/assets/profile1.jpg", IsOnline=true}
                };
            }
        }
        ...
        public List<ConversationMessages> Messages
        {
            get {
                return new List<ConversationMessages>
                {
                    ...
                    new ConversationMessages() { Message="tạm biệt", MessageStatus="Sent", TimeStamp="Today 06:18 AM", IsAudioTrack= Visibility.Collapsed},
                    new ConversationMessages()
{
    Message = "xin chao, day la uit",
    MessageStatus = "Sent",
...
new ConversationMessages()
{
    ...
    ImageSource = "/assets/uit.png" ,// Đảm bảo file ảnh này nằm trong project và được Build Action: Resource
    IsPicture = true,
    IsAudioTrack = Visibility.Collapsed
}
